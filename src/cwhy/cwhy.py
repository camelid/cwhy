...
def wrapper(args, command: List[str]):
    """
    Process the command in command, with possible modifier flags in args.
    This command ignores the --compiler-wrapper or command flags.
    These must be part of the command argument at this point.
    """
